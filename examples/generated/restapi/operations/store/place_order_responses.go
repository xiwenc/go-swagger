...
func (o *PlaceOrderOK) WriteResponse(rw http.ResponseWriter, producer toolkit.Producer) {
...
// WriteResponse to the client
func (o *PlaceOrderBadRequest) WriteResponse(rw http.ResponseWriter, producer toolkit.Producer) {
