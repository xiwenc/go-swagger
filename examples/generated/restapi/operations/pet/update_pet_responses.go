...
func (o *UpdatePetBadRequest) WriteResponse(rw http.ResponseWriter, producer toolkit.Producer) {
...
// WriteResponse to the client
func (o *UpdatePetNotFound) WriteResponse(rw http.ResponseWriter, producer toolkit.Producer) {
...
// WriteResponse to the client
func (o *UpdatePetMethodNotAllowed) WriteResponse(rw http.ResponseWriter, producer toolkit.Producer) {
