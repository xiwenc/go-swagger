...
func (o *FindPetsByTagsOK) WriteResponse(rw http.ResponseWriter, producer toolkit.Producer) {
...
// WriteResponse to the client
func (o *FindPetsByTagsBadRequest) WriteResponse(rw http.ResponseWriter, producer toolkit.Producer) {
