...
func (o *DeleteUserBadRequest) WriteResponse(rw http.ResponseWriter, producer toolkit.Producer) {
...
// WriteResponse to the client
func (o *DeleteUserNotFound) WriteResponse(rw http.ResponseWriter, producer toolkit.Producer) {
