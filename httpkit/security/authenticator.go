...
func httpAuthenticator(handler func(*http.Request) (bool, interface{}, error)) toolkit.Authenticator {
	return toolkit.AuthenticatorFunc(func(params interface{}) (bool, interface{}, error) {
...
func BasicAuth(authenticate UserPassAuthentication) toolkit.Authenticator {
...
func APIKeyAuth(name, in string, authenticate TokenAuthentication) toolkit.Authenticator {
