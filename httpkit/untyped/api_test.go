...
func stubAutenticator() toolkit.Authenticator {
	return toolkit.AuthenticatorFunc(func(_ interface{}) (bool, interface{}, error) { return false, nil, nil })
}
...
func TestUntypedAppValidation(t *testing.T) {
  ...
  "paths": {
	...
	opHandler := toolkit.OperationHandlerFunc(func(data interface{}) (interface{}, error) {
		return data, nil
	})
	...
	authenticator := toolkit.AuthenticatorFunc(func(params interface{}) (bool, interface{}, error) {
