...
func TestRequestBindingDefaultValue(t *testing.T) {
	...
	err := binder.Bind(req, RouteParams(nil), toolkit.JSONConsumer(), &data)
...
func TestRequestBindingForInvalid(t *testing.T) {
	...
	err = binder.Bind(req, RouteParams([]RouteParam{{"id", "1"}}), toolkit.JSONConsumer(), &data)
	assert.Error(t, err)
...
func TestRequestBindingForValid(t *testing.T) {
	...
	err := binder.Bind(req, []RouteParam{{"id", "1"}}, toolkit.JSONConsumer(), &data2)
	...
	err = binder.Bind(req, []RouteParam{{"id", "1"}}, toolkit.JSONConsumer(), &data3)
...
func TestFormUpload(t *testing.T) {
	...
	data := formRequest{}
	res := binder.Bind(req, nil, toolkit.JSONConsumer(), &data)
	...
	data = formRequest{}
	assert.Error(t, binder.Bind(req, nil, toolkit.JSONConsumer(), &data))
}

type fileRequest struct {
	Name string       // body
	File toolkit.File // upload
}
...
func TestBindingFileUpload(t *testing.T) {
	...
	data := fileRequest{}
	assert.NoError(t, binder.Bind(req, nil, toolkit.JSONConsumer(), &data))
	assert.Equal(t, "the-name", data.Name)
