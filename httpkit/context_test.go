...
func TestServe(t *testing.T) {
	...
	request.Header.Add("Content-Type", toolkit.JSONMime)
	request.Header.Add("Accept", toolkit.JSONMime)
...
func TestContextAuthorize(t *testing.T) {
	...
	request, _ := toolkit.JSONRequest("GET", "/pets", nil)
...
func TestContextRender(t *testing.T) {
	...
	request.Header.Set(toolkit.HeaderAccept, ct)
	ri, _ := ctx.RouteInfo(request)
...
func TestContextValidContentType(t *testing.T) {
	...
	request, _ := http.NewRequest("GET", "http://localhost:8080", nil)
	request.Header.Set(toolkit.HeaderContentType, ct)
