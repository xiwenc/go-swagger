...
func TestResponseFormatValidation(t *testing.T) {
	...
	request.Header.Set(toolkit.HeaderContentType, "application/json")
	request.Header.Set(toolkit.HeaderAccept, "application/json")
	...
	request, _ = http.NewRequest("POST", "/pets", bytes.NewBuffer([]byte(`{"name":"Dog"}`)))
	request.Header.Set(toolkit.HeaderContentType, "application/json")
	request.Header.Set(toolkit.HeaderAccept, "application/sml")
