...
type RoutableAPI interface {
	...
	ConsumersFor([]string) map[string]toolkit.Consumer
	ProducersFor([]string) map[string]toolkit.Producer
	AuthenticatorsFor(map[string]spec.SecurityScheme) map[string]toolkit.Authenticator
...
type MatchedRoute struct {
	routeEntry
	Params   RouteParams
	Consumer toolkit.Consumer
	Producer toolkit.Producer
}
